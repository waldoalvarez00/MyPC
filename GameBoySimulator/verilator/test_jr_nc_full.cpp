...
int main() {
    ...
    rom[0x150] = 0x37;  // SCF
    rom[0x151] = 0x38; rom[0x152] = 0x02;  // JR C, +2 (should jump to 0x154)
    rom[0x153] = 0x76;  // HALT (skip)
    rom[0x154] = 0x3F;  // CCF
    rom[0x155] = 0x30; rom[0x156] = 0x02;  // JR NC, +2 (should jump to 0x158)
    rom[0x157] = 0x76;  // HALT (skip)
    rom[0x158] = 0x00;  // NOP
    rom[0x159] = 0x76;  // HALT (end)
    ...
    printf("Full PC trace (will stop after 100000 cycles):\n");
