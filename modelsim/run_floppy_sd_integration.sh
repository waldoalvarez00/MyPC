...
echo ""
echo "Compiling floppy_disk_manager module and testbench..."
echo ""
...
if [ ${PIPESTATUS[0]} -ne 0 ]; then
    ...
    echo "Common issues:"
    echo "  - Missing floppy_disk_manager.sv source file"
...
echo ""
echo "================================================================"
echo "Running Floppy SD Integration Simulation"
echo "================================================================"
echo ""
...
if grep -q "ALL TESTS PASSED" simulation.log; then
    echo "✓✓✓ SUCCESS: All MiSTer SD integration tests passed! ✓✓✓"
    exit 0
else
