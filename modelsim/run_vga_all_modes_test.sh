#!/bin/bash
# Run VGA All Modes Detection Test
...
RESULTS_DIR="sim_results_vga_all_modes_$TIMESTAMP"
mkdir -p "$RESULTS_DIR"

echo "================================================================"
echo "Compiling VGA All Modes Detection Test"
echo "================================================================"
echo ""
...
iverilog -g2012 \
    -DICARUS \
    -o "$RESULTS_DIR/vga_all_modes_tb" \
    -s vga_all_modes_tb \
    -I../Quartus/rtl/VGA \
...
echo ""
echo "================================================================"
echo "Running VGA All Modes Detection Test"
echo "================================================================"
echo ""

# Run simulation
cd "$RESULTS_DIR"
vvp vga_all_modes_tb 2>&1 | tee simulation.log
...
if grep -q "*** SOME TESTS FAILED ***" "$RESULTS_DIR/simulation.log"; then
    ...
    exit 1
elif grep -q "*** ALL MODE DETECTION TESTS PASSED ***" "$RESULTS_DIR/simulation.log"; then
    echo ""
    echo -e "${GREEN}✓✓✓ SUCCESS: All mode detection tests passed! ✓✓✓${NC}"
    exit 0
else
    echo ""
