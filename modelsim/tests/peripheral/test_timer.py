...
Native Python test class for the Timer/Programmable Interval Timer.
"""
...
class TestTimer(IverilogTest):
    """Timer/PIT unit test using native Python test class."""

    name = "timer"
    category = "peripheral"
    timeout = 300  # Timer tests can take a while
