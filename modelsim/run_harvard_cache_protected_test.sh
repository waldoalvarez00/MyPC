...
set -e
echo "============================================================"
echo "Harvard Cache Protected Address Test"
echo "============================================================"
TOP_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
iverilog -g2012 -o harvard_cache_protected_tb \
    "$TOP_DIR/modelsim/harvard_cache_protected_tb.sv" \
...
vvp harvard_cache_protected_tb
